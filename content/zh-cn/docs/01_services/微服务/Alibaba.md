...
基于[Spring Cloud Alibaba](https://github.com/alibaba/spring-cloud-alibaba)的微服务开源套件[Nacos](https://nacos.io/zh-cn/)、[Sentinel](https://sentinelguard.io/zh-cn/)等搭建微服务平台。
