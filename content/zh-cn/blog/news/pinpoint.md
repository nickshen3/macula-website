...
![/admin-guide/images/pinpoint-home.png](/docs/imgs/blog/pinpoint-home.png)

> 这里的用户请求是请求DubboProvider数量的双倍，原因是记录了favicon.ico图标请求导致的

### 调用树

![/admin-guide/images/pinpoint-calltree.png](/docs/imgs/blog/pinpoint-calltree.png)

### 深入跟踪

![/admin-guide/images/pinpoint-mixedview.png](/docs/imgs/blog/pinpoint-mixedview.png)
